export function dropdownMenu() {
    const btnOpenDropDown = document.querySelector('.portfolio_header_btnInfo'),
          dropDown = document.querySelector('.portfolio_header_menu'),
          modal = document.querySelector('dialog'),
          btnContacts = document.querySelector('#contacts');
...
export function handleDocumentClick(e) {
    const dropDown = document.querySelector('.portfolio_header_menu'),
          linksBtn = document.querySelector('.portfolio_links_btn'),
          linksMenu = document.querySelector('.portfolio_links');
